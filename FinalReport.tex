...
\section{Technical Approach}
	\begin{figure}
		...
		text width=5em, text centered, rounded corners, minimum height=4em, node distance=1.5cm]
		\tikzstyle{fclayer} = [rectangle, draw, fill=red!20, 
		text width=5em, text centered, rounded corners, minimum height=4em, node distance=1.5cm]
		\tikzstyle{line} = [draw, -latex']
		\tikzstyle{h} = [draw, rectangle,fill=white!20, node distance=1.5cm,
		minimum height=2em]
		\tikzstyle{hc} = [draw, rectangle,fill=white!20, node distance=2.5cm,
		minimum height=2em]
		...
		% Place nodes
		\node [char] (inputchar) {input character};
		\node [fclayer, above of=inputchar] (char2hidden) {character to hidden layer};
		...
		\node [fclayer, above of=h2t] (hidden2char) {hidden to character layer};
		\node [char, above of=hidden2char] (outputchar) {output character};
		% Draw edges
